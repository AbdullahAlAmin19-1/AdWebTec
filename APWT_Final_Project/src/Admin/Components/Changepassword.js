...
const ChangePassBody = () => {
    ...
    const handleForm = (event) => {
        ...
        // console.log(data);
        AxiosConfig.post("admin/changepassword", data).
            then((succ) => {
                            ...
                            <div className="card mb-4 mt-1">
                                <div className="card-body text-center">
                                    ...
                                    <div className="d-flex justify-content-center mb-2">
                                        <button type="button" className="btn btn-primary"><Link className='nav-link' to={`/admin/editprofile/${admin.id}`}>Edit Profile</Link></button>
                                        <button type="button" className="btn btn-outline-primary ms-1"><Link className='nav-link' to="/admin/profile">Go Back</Link></button>
                                    </div>
                                </div>
                            </div>
                        </div>
