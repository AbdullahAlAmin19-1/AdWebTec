...
const ChangePassBody = () => {
    ...
    useEffect(() => {
        document.title = 'Grocery OS - Change Password';
    ...
    const handleForm = (event) => {
        ...
        // console.log(data);
        AxiosConfig.post("customer/changepass", data).
            then((succ) => {
            ...
            <div className="container-fluid p-4">
                <div className="card">
                    <div className="card-header">
                        <h3 className="text-center">Customer Password Change</h3>
                    </div>
                                ...
                                <div className="card mb-4 mt-1">
                                    <div className="card-body text-center">
                                        ...
                                        <div className="d-flex justify-content-center mb-2">
                                            ...
                                            <button type="button" className="btn btn-outline-primary ms-1"><Link className='nav-link' to="/customer/profileinfo">Go Back</Link></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
