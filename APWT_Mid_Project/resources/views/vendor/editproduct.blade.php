            ...
            <form action="" method="POST">
                ...
                {{@csrf_field()}}
                    <tr>
                        ...
                        <td><input type="text" id='name' name="name" placeholder="Write Vendor Id" value="{{$p->v_id}}"></td>
                    ...
                    <tr>
                        <th><label for="name">Product Name:</label></th>
                        <td><input type="text" id='name' name="name" placeholder="Write Product id" value="{{$p->p_id}}"></td>
                        <td>@error('name'){{$message}}@enderror</td>
                    </tr>
                    <tr>
