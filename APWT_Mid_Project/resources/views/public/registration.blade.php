...
<fieldset>
    ...
    User Name: <input type="text" name="uname" placeholder="Write Your User Name" value="{{old('uname')}}"> @error('uname'){{$message}}@enderror<br><br>
    Email: <input type="text" name="email" placeholder="Write Your Email" value="{{old('email')}}"> @error('email'){{$message}}@enderror<br><br>
    Phone Number: <input type="text" name="phone" placeholder="Write Your Phone Number" value="{{old('phone')}}"> @error('phone'){{$message}}@enderror<br><br>
    ...
    Gender: <input type="radio" id="male" name="gender" value="Male"><label for="male">Male</label>
            ...
            <input type="radio" id="others" name="gender" value="Others"><label for="others">Others</label> @error('gender'){{$message}}@enderror<br><br>
    Date of Birth: <input type="date" id="dob" name="dob" value="{{old('email')}}"> @error('dob'){{$message}}@enderror<br><br>
    Address: <input type="text" name="address" placeholder="Write Your Address" value="{{old('address')}}"> @error('address'){{$message}}@enderror<br><br>
